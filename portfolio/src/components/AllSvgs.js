...
export const PowerBtn = (props) => {
  ...
  export const Github = (props) => {
      return (
        <SocialIcon url="https://github.com/ravindrakumartirdiya" style={{ height: 35, width: 35, margin:"2px" }} />
        )
  }
  
  export const Instagram = (props) => {
      return (
        <SocialIcon url="https://instagram.com/ravindra_tirdiya" style={{ height: 35, width: 35, margin:"2px" }} />
        )
  }
  
  export const Linkedin = (props) => {
      return (
        <SocialIcon url="https://www.linkedin.com/in/ravindra-kumar-tirdiya-11b30220b/" style={{ height: 35, width: 35, margin:"2px" }} />
        )
  }
  
  export const Whatsapp = (props) => {
      return (
        <SocialIcon url="https://api.whatsapp.com/send?phone=+917891517453" style={{ height: 35, width: 35, margin:"2px" }} />
        )
  }
